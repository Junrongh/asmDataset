...
micrographs_info = pd.read_csv('Micrograph_Data.csv',
    ...
    for i in micrographs_info.index:
        ...
        if micrographs_info.loc[i]['main'] == main:
            if micrographs_info.loc[i]['Image Code'] not in m_missed:
                ...
                dic['main'] = main
                dic['ori_image'] = imread(os.path.join(
                    root_path, main, path), as_grey=True)
                dic['scaled_image'] = imread(
                    os.path.join(scaled_root_path, main, path))
                main_dic.append(dic)
    return main_dic
...
overview_dic = [al_dic, as_dic, cc_dic, ci_dic, co_dic, cs_dic, cu_dic, cu_dic,
                hs_dic, lz_dic, mg_dic, ni_dic, pl_dic, rf_dic, sc_dic, sp_dic,
                ss_dic, ti_dic, ts_dic, un_dic]
